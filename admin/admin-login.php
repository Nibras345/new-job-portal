...
<body class="text-center">
    <form class="form-signin" id="admin_login" name="admin_login" action="admin-login.php" method="post">
        <img class="mb-4" src="../img/login-logo.png" alt="" width="100px" height="100px">
